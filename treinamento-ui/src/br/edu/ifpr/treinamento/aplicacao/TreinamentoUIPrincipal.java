...
public class TreinamentoUIPrincipal extends Application {
   private static final Logger LOGGER =
                         Logger.getLogger(TreinamentoUIPrincipal.class.getName());

   private static final String FXML_PATH_NAME =
                               "/br/edu/ifpr/treinamento/aplicacao/ui/gui/jfx/";
   private static final String FXML_FILE_NAME = FXML_PATH_NAME +
                                                "Principal_GridImage.fxml";
   ...
   public void start(Stage primaryStage) {
      ...
      try {
         ...
         String     css    = getClass().getResource(CSS_FILE_NAME)
                                       .toExternalForm();
